export const translations = {
  en: {
    ...
    reg_label_nic: "CNIC Number",
    reg_placeholder_nic: "CNIC Number daalen (e.g. 12345-1234567-1)",
  ...
  ur: {
    ...
    reg_error_duplicate_nic: "Is CNIC se pehle hi 2 reports darj hain.",
